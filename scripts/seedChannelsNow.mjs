...
const INITIAL_CHANNELS = [
  ...
  { name: "Investopedia", channelId: "UCf3bY5r9Jxq5K1e2QfQ9Q9w", category: "Money" },
  ...
  { name: "YaleCourses", channelId: "UC4a-Gbdw7vOaccHmFo40b9g_yale", category: "Random" },
];
...
async function seedNow() {
  try {
    console.log("Connecting to MongoDB to seed 25 channels...");
    ...
    console.log(`SUCCESSFULLY SEEDED CHANNELS! Total channels in DB: ${count}`);
